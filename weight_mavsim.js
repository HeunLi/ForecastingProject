...
//   var mma3 = row3.cells[2];
  ...
  // Calculate MAV
  var mav1 = (parseFloat(cell1.innerHTML * 1) + parseFloat(cell2.innerHTML * 2) + parseFloat(cell3.innerHTML * 3)) / 6;
  var mav2 = (parseFloat(cell2.innerHTML * 1) + parseFloat(cell3.innerHTML * 2) + parseFloat(cell4.innerHTML * 3)) / 6;
  var mav3 = (parseFloat(cell3.innerHTML * 1) + parseFloat(cell4.innerHTML * 2) + parseFloat(cell5.innerHTML * 3)) / 6;
  var mav4 = (parseFloat(cell4.innerHTML * 1) + parseFloat(cell5.innerHTML * 2) + parseFloat(cell6.innerHTML * 3)) / 6;
  var mav5 = (parseFloat(cell5.innerHTML * 1) + parseFloat(cell6.innerHTML * 2) + parseFloat(cell7.innerHTML * 3)) / 6;
  var mav6 = (parseFloat(cell6.innerHTML * 1) + parseFloat(cell7.innerHTML * 2) + parseFloat(cell8.innerHTML * 3)) / 6;
  var mav7 = (parseFloat(cell7.innerHTML * 1) + parseFloat(cell8.innerHTML * 2) + parseFloat(cell9.innerHTML * 3)) / 6;
  var mav8 = (parseFloat(cell8.innerHTML * 1) + parseFloat(cell9.innerHTML * 2) + parseFloat(cell10.innerHTML * 3)) / 6;
  var mav9 = (parseFloat(cell9.innerHTML * 1) + parseFloat(cell10.innerHTML * 2) + parseFloat(cell11.innerHTML * 3)) / 6;
  var mav10 = (parseFloat(cell10.innerHTML * 1) + parseFloat(cell11.innerHTML * 2) + parseFloat(cell12.innerHTML * 3)) / 6;
